...
import { changePasswordAsync } from "@/features/profile/profileThunk";
...
export default function ChangePasswordModal({
  ...
  const handlePasswordSubmit = async (data: PasswordValues): Promise<void> => {
    try {
      ...
      // ✅ Type-narrow 'unknown' safely instead of using 'any'
      const errorMessage =
