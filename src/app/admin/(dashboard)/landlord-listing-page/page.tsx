...
//   Mail, Phone, Eye, Clock, Loader2, ShieldCheck, AlertCircle 
// } from 'lucide-react';
// import { useAppDispatch, useAppSelector } from '@/store/hooks';
// import { approveKycAsync, fetchLandlordsAsync, rejectKycAsync, toggleUserStatusAsync } from '@/features/users/usersThunks';
...
//     dispatch(approveKycAsync({id}));
//   };

//   const handleRejectKyc = (id: string) => {
//     dispatch(rejectKycAsync({id}));
//   };
...
//                       {/* KYC Actions for PENDING only */}
//                       {landlord.kycStatus === 'PENDING' && (
//                         <>
//                           <button 
//                             onClick={() => handleApproveKyc(landlord.id)}
//                             className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-[10px] font-bold text-emerald-600 bg-emerald-50 hover:bg-emerald-100 transition-all active:scale-95 border border-emerald-100"
//                           >
//                             <CheckCircle size={14} /> APPROVE
//                           </button>
//                           <button 
//                             onClick={() => handleRejectKyc(landlord.id)}
//                             className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-[10px] font-bold text-rose-600 bg-rose-50 hover:bg-rose-100 transition-all active:scale-95 border border-rose-100"
//                           >
//                             <Ban size={14} /> REJECT
//                           </button>
//                         </>
