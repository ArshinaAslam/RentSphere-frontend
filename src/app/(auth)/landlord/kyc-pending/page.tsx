...
const KycPendingPage = () => {
  ...
  const { kycId, kycStatus, kycRejectedReason } = useAppSelector(
    (state) => state.kyc,
  );
  ...
  useEffect(() => {
    ...
    if (email) {
      void dispatch(fetchKycStatusAsync(email));
    }
  }, [dispatch]);
      ...
      <div className="min-h-screen bg-gradient-to-b from-emerald-50 to-white flex items-center justify-center py-12 px-4">
        <div className="max-w-md w-full text-center">
          ...
          <p className="text-emerald-700 mb-8 text-sm leading-relaxed">
            Your identity has been verified. You can now login to your landlord
            dashboard.
          </p>
          ...
          <div className="bg-emerald-50 border border-emerald-100 rounded-2xl p-6 mb-8">
            <p className="text-emerald-800 text-sm font-medium">
              KYC ID:{" "}
              <code className="bg-emerald-100 px-2 py-1 rounded text-xs font-mono">
                {kycId}
              </code>
            </p>
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white flex items-center justify-center py-12 px-4">
      <div className="max-w-md w-full text-center">
        ...
        <div className="bg-emerald-50 border border-emerald-100 rounded-2xl p-6 mb-8">
          ...
          <p className="text-emerald-800 text-xs mt-1">
            Status:{" "}
            <span className="font-bold text-yellow-700">{kycStatus}</span>
          </p>
        </div>
