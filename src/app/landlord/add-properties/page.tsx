            ...
            <form onSubmit={(e) => void handleSubmit(e)} className="space-y-8">
              ...
              <CardContent className="space-y-6">
                  ...
                  <div className="space-y-3">
                    <div className="border-2 border-dashed border-slate-300 rounded-2xl p-8 text-center hover:border-emerald-400 transition-colors bg-slate-50 hover:bg-emerald-50">
                      ...
                      <p className="text-sm text-slate-500 mt-2">
                        PNG, JPG up to 5MB each. Multiple images supported.
                      </p>
                    </div>
                    ...
                    {imagePreviews.length > 0 && (
                      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3">
                        {imagePreviews.map((preview, index) => (
                          <div
                            key={index}
                            className="relative group bg-slate-100 rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-all"
                          >
                            <img
                              src={preview}
                              alt="Preview"
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
                    {[
                      ...
                      <label
                        key={amenity}
                        className="flex items-center gap-3 p-3 border border-slate-200 rounded-xl hover:bg-slate-50 cursor-pointer transition-all group"
                      >
                        <input
                          type="checkbox"
                          value={amenity}
                ...
                <div className="flex flex-col sm:flex-row gap-4 pt-4">
                  <Button
                    type="submit"
                    className="flex-1 h-12 text-lg font-semibold bg-emerald-600 hover:bg-emerald-700"
                    disabled={loading}
                  >
                    {loading ? (
                      <>
