...
import { changeLandlordPasswordAsync } from '@/features/auth/authThunks';
...
//     try {
//       await dispatch(changeLandlordPasswordAsync(data)).unwrap();
...
//       form.reset();
//     } catch {
//       toast.error("❌ Password change failed", { description: "Please try again." });
//     }
//   };
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(handlePasswordSubmit)} className="space-y-5">
            ...
            <div className="flex gap-3 pt-4">
              ...
              <Button type="submit" className="flex-1 bg-emerald-600 hover:bg-emerald-700 h-12 rounded-xl font-bold shadow-lg">
                Update Password
              </Button>
            </div>
          </form>
