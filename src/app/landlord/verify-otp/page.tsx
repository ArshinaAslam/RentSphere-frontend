// app/landlord/verify-otp/page.tsx
'use client';

import React from "react";
import { useRouter } from "next/navigation";
import { useAppDispatch, useAppSelector } from "@/store/hooks";
import { resendOtpAsync, verifyLandlordOtpAsync } from "@/features/auth/authThunks"; // ← Change thunk
...
export default function LandlordOtpVerification() {
  ...
  // ✅ Same: get email from sessionStorage
  const email = typeof window !== 'undefined' ? sessionStorage.getItem('signupEmail') || '' : '';

  // ✅ Same: handleVerify, handleResend, OtpForm, header
