...
//   const { propertyInquiries, isLoadingInquiries } = useAppSelector(
//     (s: RootState) => s.inquiry,
//   );


//   console.log("propertyInquiries",propertyInquiries)
...
//                 Property Inquiries
//               </h1>
//               <p className="text-sm text-slate-500">Manage tenant interest</p>
//             </div>
//           </div>
