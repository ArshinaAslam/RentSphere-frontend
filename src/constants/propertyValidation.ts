...
export const propertySchema = z
  .object({
    ...
    securityDeposit: z
      ...
      .refine((v) => Number(v) > 0, "Security deposit must be greater than 0"),
    vacant: z
      .string()
      .min(1, "Vacant units is required")
    ...
    area: z
      ...
      .refine((v) => Number(v) > 0, "Area must be greater than 0"),
  ...
  .refine((data) => Number(data.securityDeposit) <= Number(data.price), {
