...
type LeasePreFill = NonNullable<LeaseState['preFill']>;
...
const leaseSlice = createSlice({
  ...
  initialState,
  reducers: {
    clearActiveLease: (state) => {
      state.activeLease = null;
    },
    clearError: (state) => {
      state.error = null;
    },
    setLeasePreFill(state,  action: PayloadAction<LeasePreFill>) {
      state.preFill = action.payload;
    },
    clearLeasePreFill(state) {
      state.preFill = null;
    },
  },
  extraReducers: (builder) => {
    builder
      ...
      .addCase(fetchLandlordLeases.fulfilled, (state, action) => {
        ...
        state.leases = Array.isArray(action.payload.leases)
          ? action.payload.leases
          : [];
        state.pagination = {
      ...
      .addCase(fetchLeaseById.fulfilled, (state, action) => {
        state.isLoading = false;
        state.activeLease = action.payload;
      })
      ...
      // create
      .addCase(createLeaseThunk.pending, (state) => {
        state.isSubmitting = true;
      })
      .addCase(createLeaseThunk.fulfilled, (state, action) => {
        state.isSubmitting = false;
        state.leases.unshift(action.payload);
      })
      .addCase(createLeaseThunk.rejected, (state, action) => {
        state.isSubmitting = false;
        state.error = action.payload as string;
      })
      ...
      .addCase(updateLeaseThunk.fulfilled, (state, action) => {
        ...
        if (state.activeLease?._id === action.payload._id)
          state.activeLease = action.payload;
      })
      ...
      // fetch tenant leases
      .addCase(fetchTenantLeases.pending, (state) => {
        state.isLoading = true;
      })
      .addCase(fetchTenantLeases.fulfilled, (state, action) => {
        state.isLoading = false;
        state.leases = action.payload;
      })
      .addCase(fetchTenantLeases.rejected, (state, action) => {
        state.isLoading = false;
        state.error = action.payload as string;
      })

      // fetch tenant lease by id
      .addCase(fetchTenantLeaseById.pending, (state) => {
        state.isLoading = true;
      })
      .addCase(fetchTenantLeaseById.fulfilled, (state, action) => {
        state.isLoading = false;
        state.activeLease = action.payload;
      })
      .addCase(fetchTenantLeaseById.rejected, (state, action) => {
        state.isLoading = false;
        state.error = action.payload as string;
      })
      ...
      // sign
      .addCase(signLeaseThunk.pending, (state) => {
        state.isSubmitting = true;
      })
      ...
      .addCase(signLeaseThunk.rejected, (state, action) => {
        state.isSubmitting = false;
        state.error = action.payload as string;
      });
  },
