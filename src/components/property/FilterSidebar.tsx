      ...
      <div className="space-y-8">
        <div>
          ...
          <div className="space-y-2">
            <button className="w-full text-left px-4 py-2.5 rounded-xl bg-emerald-50 text-emerald-700 font-bold text-sm">
              Newest First
            </button>
            <button className="w-full text-left px-4 py-2.5 rounded-xl text-slate-500 hover:bg-slate-50 font-medium text-sm">
              Price: Low—High
            </button>
            <button className="w-full text-left px-4 py-2.5 rounded-xl text-slate-500 hover:bg-slate-50 font-medium text-sm">
              Price: High—Low
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-2">
            {["Apartment", "Villa", "House"].map((type) => (
              <button
                key={type}
                className="px-4 py-2 rounded-full border border-slate-200 text-slate-600 text-sm font-medium hover:border-emerald-500 transition-colors"
              >
                {type}
              </button>
            ))}
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-2">
            {["1 BHK", "2 BHK", "3 BHK", "4+ BHK"].map((bhk) => (
              <button
                key={bhk}
                className="px-4 py-2 rounded-full border border-slate-200 text-slate-600 text-sm font-medium hover:border-emerald-500"
              >
                {bhk}
              </button>
            ))}
